...
from FinalApp_RamSe.models import *
from FinalApp_RamSe.forms import *
...
def inicio(request):
    ...
    return render(request, "FinalApp_RamSe/inicio.html")
...
def editarPerfil(request):
    ...
    return render(request, "FinalApp_RamSe/editarPerfil.html", {"miFormulario": miFormulario, "usuario": usuario})
...
def autoFormulario(request):
    ...
    return render(request, "FinalApp_RamSe/autoFormulario.html", {"miFormulario": miFormulario})
...
def clienteFormulario(request):
    ...
    return render(request, "FinalApp_RamSe/clienteFormulario.html", {"miFormulario": miFormulario})
...
def serviceFormulario(request):
    ...
    return render(request, "FinalApp_RamSe/serviceFormulario.html", {"miFormulario": miFormulario})
...
def busquedaAuto(request):
      ...
      return render(request,"FinalApp_RamSe/busquedaAuto.html")
...
def buscarAuto(request):
      ...
      if request.GET["patente"]:
            ...
            return render(request, "FinalApp_RamSe/resultadosBusquedaAuto.html",{"autos":autos, "patente": patente})
      else:
            return render(request, "FinalApp_RamSe/paginaError.html",{"mensaje":"No se enviaron datos para la búsqueda"})
...
def busquedaCliente(request):
      ...
      return render(request,"FinalApp_RamSe/busquedaCliente.html")
...
def buscarCliente(request):
      ...
      if request.GET["nombre"]:
            ...
            return render(request, "FinalApp_RamSe/resultadosBusquedaCliente.html",{"Clientes": clientes, "nombre": nombre})
      else:
            return render(request, "FinalApp_RamSe/paginaError.html",{"mensaje":"No se enviaron datos para la búsqueda"})
...
def busquedaService(request):
      ...
      return render(request,"FinalApp_RamSe/busquedaService.html")
...
def buscarService(request):
      ...
      if request.GET["fecha"]:
            ...
            return render(request, "FinalApp_RamSe/resultadoBusquedaService.html",{"services": services, "fecha": fecha})
      else:
            return render(request, "FinalApp_RamSe/paginaError.html",{"mensaje":"No se enviaron datos para la búsqueda"})
...
def leerAutos(request):
    ...
    return render(request, "FinalApp_RamSe/leerAutos.html",contexto)
...
def leerClientes(request):
    ...
    return render(request, "FinalApp_RamSe/leerClientes.html",contexto)
...
def leerServices(request):
    ...
    return render(request, "FinalApp_RamSe/leerServices.html",contexto)
...
@login_required
def eliminarCliente(request, dni1):

    cliente = Cliente.objects.get(dni = dni1) #trae todos los clientes
    cliente.delete()
...
def editarAuto(request, patente):
    ...
    if request.method == 'POST':
        ...
        return render(request, "FinalApp_RamSe/leerAutos.html")
    ...
    return render(request, "FinalApp_RamSe/editarAuto.html", {"miFormulario": miFormulario, "patente": patente})
...
def editarCliente(request, dni):
    ...
    if request.method == 'POST':
        ...
        if miFormulario.is_valid:
            ...
            cliente.save()
        return render(request, "FinalApp_RamSe/leerClientes.html")
    
    else:
        miFormulario = ClienteFormulario(initial={'dni': cliente.dni, 'nombre': cliente.nombre, 'telefono': cliente.telefono})

    return render(request,"FinalApp_RamSe/editarCliente.html",{"miFormulario":miFormulario,"dni":dni})
...
def editarService(request, comprobante):
    ...
    if request.method == 'POST':
        ...
        return render(request, "FinalApp_RamSe/leerServices.html")
    ...
    # Voy al html que me permite editar
    return render(request, "FinalApp_RamSe/editarService.html", {"miFormulario": miFormulario, "comprobante": comprobante})
    ...
    if request.method == 'POST':
        ...
        if form.is_valid(): 
            ...
            if user is not None:
                ...
                login(request, user)
                return render(request, "FinalApp_RamSe/inicio.html", {"mensaje":f"Bienvenido {usuario}","avatar":avatar})
            else:
                return render(request, "FinalApp_RamSe/inicio.html", {"mensaje":"Datos incorrectos"})
        else:
            return render(request, "FinalApp_RamSe/inicio.html", {"mensaje":"Formulario erroneo"})
    form = AuthenticationForm()
    return render(request, "FinalApp_RamSe/login.html", {"form": form})
...
def register(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            form.save()
            return render(request,"FinalApp_RamSe/inicio.html" , {"mensaje":"Usuario Creado :)"})
    else:
        form = UserRegisterForm()
    return render(request,"FinalApp_RamSe/registro.html" , {"form":form})


def aboutMe(request):

    return render(request,"FinalApp_RamSe/aboutMe.html")
...
def pages(request):
    ...
    return render(request, "FinalApp_RamSe/pages.html",contexto)
...
def comentarioFormulario(request):
    ...
    return render(request, "FinalApp_RamSe/comentarioFormulario.html", {"miFormulario": miFormulario})
...
def verMas(request, id):
    ...
    return render(request, "FinalApp_RamSe/leerComentario.html", contexto)
    

def home(request):

    return render(request, "FinalApp_RamSe/home.html")
